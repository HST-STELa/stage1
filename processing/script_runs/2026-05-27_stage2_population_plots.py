...
fd = paths.population_plots / 'transit detectability'
...
frac_fig.savefig(fd / f'{date} detectability fraction vs lya flux plot.png')

flat_fig, flat_ax = make_detectability_plot('flat transit snr', snr_floor)
flat_ax.set_ylabel('Simple Flat Transit SNR')
flat_fig.tight_layout()
flat_fig.savefig(fd / f'{date} flat transit SNR vs lya flux plot.png')
...
frac_fig_scat.savefig(fd / f'{date} detectability fraction population.png')
...
flat_fig_scat.savefig(fd / f'{date} flat transit SNR population.png')