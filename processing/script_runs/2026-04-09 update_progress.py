...
332064670
""".strip().split()
tics_for_lya = np.array(tics_for_lya, int)
targets_for_lya_flux_calcs = dbutils.stela_name_tbl.loc['tic_id', tics_for_lya]['hostname_file']
...
backup_mask = np.zeros(len(target_info), bool)
