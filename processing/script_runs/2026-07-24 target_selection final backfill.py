...
diff_label = 'target-backfill-ttrb-only-2026-07'
...
n_orbits_check = sum(targets[f'stage1_{grating}'][guaranteed].filled(0).sum() for grating in 'g140m g140l e140m g130m'.split())
